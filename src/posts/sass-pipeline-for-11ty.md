...
!!! note Tip:
    Store your .scss file somewhere that is watched by the 11ty CLI to get hot reloading. I recommend the _includes directory because it isn't included in the built output.
