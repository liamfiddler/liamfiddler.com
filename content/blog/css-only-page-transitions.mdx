...
description: How to create smooth animated transitions between different states of your web pages, even across full page navigations.
date: 2025-06-15
tags: ['how to', 'web development', 'styling']
---
