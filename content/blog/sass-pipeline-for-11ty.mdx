...
description: How to add SASS support to 11ty.
date: 2019-07-01
...
The code below assumes you've got your SASS code in a file at **\_includes/main.scss** and want to output the resulting CSS to _style.css_. If you want to save them somewhere else change the `inputFile` and `outputFile` variables.
...
Save the following code as _style.11ty.js_ and install the dependencies listed in the comments.
